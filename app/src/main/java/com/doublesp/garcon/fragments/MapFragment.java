package com.doublesp.garcon.fragments;
...
import com.doublesp.garcon.googleplace.GooglePlaceClient;
import com.doublesp.garcon.googleplace.gplace.GPlace;
import com.doublesp.garcon.googleplace.gplace.Result;
import com.doublesp.garcon.utils.LocationClusterItem;
...
//            }
    ...
    private void addItems(List<Result> stores) {
        ...
        for (Result store : stores) {
            com.doublesp.garcon.googleplace.gplace.Location location = store.getGeometry().getLocation();
...
//        textView.setCompoundDrawablePadding(getResources().getDimensionPixelOffset(R.dimen.snackbar_icon_padding));
    ...
    private void beginNavigation(Result store) {
        com.doublesp.garcon.googleplace.gplace.Location destLocation = store.getGeometry().getLocation();
