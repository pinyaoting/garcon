...
import com.pinyaoting.garcon.googleplace.GooglePlaceClient;
import com.pinyaoting.garcon.googleplace.gplace.GPlace;
import com.pinyaoting.garcon.googleplace.gplace.Result;
import com.pinyaoting.garcon.utils.LocationClusterItem;
...
//        textView.setCompoundDrawablePadding(getResources().getDimensionPixelOffset(R.dimen.snackbar_icon_padding));
    ...
    private void beginNavigation(Result store) {
        com.pinyaoting.garcon.googleplace.gplace.Location destLocation = store.getGeometry().getLocation();
