...
import com.pinyaoting.garcondecuisine.googleplace.GooglePlaceClient;
import com.pinyaoting.garcondecuisine.googleplace.gplace.GPlace;
import com.pinyaoting.garcondecuisine.googleplace.gplace.Result;
import com.pinyaoting.garcondecuisine.utils.LocationClusterItem;
...
//            }
    ...
    private void addItems(List<Result> stores) {
        ...
        for (Result store : stores) {
            com.pinyaoting.garcondecuisine.googleplace.gplace.Location location = store.getGeometry().getLocation();
...
//        textView.setCompoundDrawablePadding(getResources().getDimensionPixelOffset(R.dimen.snackbar_icon_padding));
    ...
    private void beginNavigation(Result store) {
        com.pinyaoting.garcondecuisine.googleplace.gplace.Location destLocation = store.getGeometry().getLocation();
